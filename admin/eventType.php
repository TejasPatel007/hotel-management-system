          ...
          <form action="admin_functions.php" method="POST" id="modal-addEventType" autocomplete="off">
            <div class="row">
              ...
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="typeName" type="text" name="eventTypeName" placeholder="Event Type Name"
              ...
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="cost" type="text" name="eventCost" placeholder="Cost"
                  class="form-control bg-white border-left-0 border-md" required>
              </div>
              <!-- Desc -->
              <div class="input-group col-lg-11 ml-3 mb-4">
          ...
          <form action="admin_functions.php" method="POST" id="modal-editEventType" autocomplete="off">
            <div class="row">
              ...
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="editEventTypeName" type="text" name="editEventTypeName" placeholder="Event Type Name"
                  class="form-control bg-white border-left-0 border-md" required>
              </div>
              <!-- Cost -->
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="editEventCost" type="text" name="editEventCost" placeholder="Cost"
                  class="form-control bg-white border-left-0 border-md" required>
              </div>
