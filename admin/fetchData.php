...
<thead class="thead-dark">
  ...
  switch ($roomTypeFilter) {
    case 1:
      $selectAllType = "SELECT * FROM room_type ";
      break;
    case 2:
      $selectAllType = "SELECT * FROM room_type WHERE Status like 'active' ";
      break;
    case 3:
      $selectAllType = "SELECT * FROM room_type WHERE Status like 'in-active' ";
      break;
    case 4:
      $selectAllType = "SELECT * FROM room_type WHERE Cost < 500 ";
      break;
    case 5:
      $selectAllType = "SELECT * FROM room_type WHERE Cost >=500 AND Cost<=1000 ";
      break;
    case 6:
      $selectAllType = "SELECT * FROM room_type WHERE Cost >1000 ";
      break;
    default:
      $selectAllType = "SELECT * FROM room_type ";
      break;
...
<thead class="thead-dark">
  ...
  switch ($roomTypeFilter) {
    case 1:
      $selectAllType = "SELECT * FROM event_type ";
      break;
    case 2:
      $selectAllType = "SELECT * FROM event_type WHERE Status like 'active' ";
      break;
    case 3:
      $selectAllType = "SELECT * FROM event_type WHERE Status like 'in-active' ";
      break;
    case 4:
      $selectAllType = "SELECT * FROM event_type WHERE Cost < 500 ";
      break;
    case 5:
      $selectAllType = "SELECT * FROM event_type WHERE Cost >=500 AND Cost<=1000 ";
      break;
    case 6:
      $selectAllType = "SELECT * FROM event_type WHERE Cost >1000 ";
      break;
    default:
      $selectAllType = "SELECT * FROM event_type ";
      break;
