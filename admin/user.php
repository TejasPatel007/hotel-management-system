                    ...
                    <form id="model-addUser" method="POST" action="admin_functions.php" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="phoneNumber" type="tel" name="contactno" pattern="[789][0-9]{9}"
                            ...
                            <div class="form-group col-lg-12 mx-auto mb-0">
                                <button id="adduser" type="submit" class="btn btn-success btn-block py-2"
                                    name="addUser">
                    ...
                    <form id="model-updateUser" method="POST" action="admin_functions.php" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="input-group col-lg-6 mb-4">
                                ...
                                <input id="updatefirstName" type="text" name="firstName" placeholder="First Name"
                                    class="form-control bg-white border-left-0 border-md" required>
                            </div>
                            ...
                            <div class="input-group col-lg-6 mb-4">
                                ...
                                <input id="updatelastName" type="text" name="lastname" placeholder="Last Name"
                                    class="form-control bg-white border-left-0 border-md" required>
                            </div>
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="updateemail" type="email" name="email" placeholder="Email Address"
                                    class="form-control bg-white border-left-0 border-md" required>
                            </div>
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="updatephoneNumber" type="tel" name="contactno" pattern="[789][0-9]{9}"
                                    placeholder="Phone Number"
                                    class="form-control bg-white border-md border-left-0 pl-3" required>
                            </div>
