            ...
            <div class="row">
                ...
                <div class="input-group col-lg-4 mb-4">
                    ...
                    <div class="input-group ">
                        ...
                        <input id="city" type="text" name="city" class="form-control bg-white border-left-0 border-md"
                            required>
                    </div>
                </div>
                <!-- Address -->
                <div class="input-group col-lg-4 mb-4">
                    ...
                    <div class="input-group ">
                        ...
                        <input id="state" type="text" name="state" class="form-control bg-white border-left-0 border-md"
                            required>
                    </div>
                </div>
                <!-- Address -->
                ...
                <div class="input-group col-lg-3 mb-4">
                    ...
                    <div class="input-group ">
                        ...
                        <input id="zip" type="text" name="zip" class="form-control bg-white border-left-0 border-md"
                            required>
                    </div>
                </div>
                <!-- description -->
                ...
                <div class="input-group col-lg-6 mb-4">
                    ...
                    <div class="input-group ">
                        ...
                        <input id="phoneNumber" type="tel" name="phoneNumber" pattern="[789][0-9]{9}"
