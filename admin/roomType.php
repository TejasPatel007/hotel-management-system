          ...
          <form action="admin_functions.php" method="POST" id="model-addRoomType" autocomplete="off">
            <div class="row">
              ...
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="typeName" type="text" name="roomTypeName" placeholder="Room Type Name"
              ...
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="cost" type="text" name="roomCost" placeholder="Cost"
                  class="form-control bg-white border-left-0 border-md" required>
              </div>
              <!-- Desc -->
              <div class="input-group col-lg-11 ml-3 mb-4">
          ...
          <form action="admin_functions.php" method="POST" id="modal-editRoomType" autocomplete="off">
            <div class="row">
              ...
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="editRoomTypeName" type="text" name="editRoomTypeName" placeholder="Room Type Name"
                  class="form-control bg-white border-left-0 border-md" required>
              </div>
              <!-- Cost -->
              <div class="input-group col-lg-11 ml-3 mb-4">
                ...
                <input id="editRoomCost" type="text" name="editRoomCost" placeholder="Cost"
                  class="form-control bg-white border-left-0 border-md" required>
              </div>
