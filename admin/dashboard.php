  ...
  <div class="row ml-4">
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card border-light mb-3" style="max-width: 36rem;">
        <div class="card-header  font-weight-bold">Room Booking Status<span class="text-muted"> (Current year)</span>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-6 col-sm-12">
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card border-light mb-3" style="max-width: 36rem;">
        <div class="card-header  font-weight-bold">Event Booking Status<span class="text-muted"> (Current year)</span>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-6 col-sm-12">
