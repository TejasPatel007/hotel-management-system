    ...
    <div class="container">
        <div class="row align-items-center my-5">
            ...
            <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
                ...
                <h1>Book a Event</h1>
                <p class="font-italic text-muted mb-0">Information provided below will be used to book a event in to your
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 mb-4">
                            ...
                            <div class="input-group ">
                                ...
                                <input id="eventTime" type="text" name="eventTime" placeholder="Event Time"
                                    class="form-control bg-white " required>
                            </div>
                        </div>
