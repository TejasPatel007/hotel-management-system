    ...
    <div class="container">
        <div class="row align-items-center my-5">
            ...
            <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
                ...
                <h1>Book a Room</h1>
                <p class="font-italic text-muted mb-0">Information provided below will be used to book a room in to your
                    <?php echo $general_setting['Name'] ?> account.
                </p>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 mb-4">
                            ...
                            <div class="input-group ">
                                ...
                                <input id="checkIn" type="text" name="checkIn" placeholder="Check-In Data"
                        ...
                        <div class="form-group col-lg-6 mb-4">
                            ...
                            <div class="input-group ">
                                ...
                                <input id="checkOut" type="text" name="checkOut" placeholder="Check-Out Data"
                                    class="form-control bg-white " required>
                            </div>
                        </div>
