    ...
    switch ($bookingTypeFilter) {
        case 1:
            $selectBooking = "SELECT rm.*,rt.RoomType,rl.RoomNumber FROM
                               ...
                               where rm.User_id = '$userId' order by rm.Date desc";
            break;
        ...
        case 2:
            $selectBooking = "SELECT rm.*,rt.RoomType,rl.RoomNumber FROM
                                room_booking rm inner join room_list rl on rl.RoomId = rm.RoomId
                                inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                where rm.User_id = '$userId' AND rm.Status= 'Booked'  order by rm.Date desc";
            break;
        ...
        case 3:
            $selectBooking = "SELECT rm.*,rt.RoomType,rl.RoomNumber FROM
                                room_booking rm inner join room_list rl on rl.RoomId = rm.RoomId
                                inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                where rm.User_id = '$userId' AND (rm.Status= 'Paid' OR rm.Status= 'CheckedOut' ) order by rm.Date desc ";
            break;
        ...
        case 4:
            $selectBooking = "SELECT rm.*,rt.RoomType,rl.RoomNumber FROM
                                room_booking rm inner join room_list rl on rl.RoomId = rm.RoomId
                                inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                where rm.User_id = '$userId' AND rm.Status= 'Cancelled'  order by rm.Date desc";
            break;
        ...
        case 5:
            $selectBooking = "SELECT rm.*,rt.RoomType,rl.RoomNumber FROM
                                room_booking rm inner join room_list rl on rl.RoomId = rm.RoomId
                                inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                where rm.User_id = '$userId' AND rm.Status= 'Rejected'  order by rm.Date desc";
            break;
        ...
        case 6:
            $selectBooking = "SELECT rm.*,rt.RoomType,rl.RoomNumber FROM
                                room_booking rm inner join room_list rl on rl.RoomId = rm.RoomId
                                inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                where rm.User_id = '$userId' AND rm.Checkout < CURDATE()  order by rm.Date desc ";
            break;

        default:
            $selectBooking = "SELECT rm.*,rt.RoomType,rl.RoomNumber FROM room_booking rm inner join room_list rl on rl.RoomId = rm.RoomId
                                inner join room_type rt on rl.RoomTypeId = rt.RoomTypeId 
                                where rm.User_id = '$userId' order by rm.Date desc";
            break;
    ...
    switch ($bookingTypeFilter) {
        case 1:
            $selectBooking = "SELECT em.*,et.EventType,el.HallNumber FROM
                                ...
                                where em.User_id = '$userId' order by em.Date desc";
            break;
        ...
        case 2:
            $selectBooking = "SELECT em.*,et.EventType,el.HallNumber FROM
                                event_booking em inner join event_list el on el.EventId = em.EventId
                                inner join event_type et on el.EventTypeId = et.EventTypeId 
                                where em.User_id = '$userId' AND em.Status = 'Booked' order by em.Date desc";
            break;
        ...
        case 3:
            $selectBooking = "SELECT em.*,et.EventType,el.HallNumber FROM
                                ...
                                AND (em.Status= 'Paid' OR em.Status= 'CheckedOut' )  order by em.Date desc";
            break;
        ...
        case 4:
            $selectBooking = "SELECT em.*,et.EventType,el.HallNumber FROM
                                event_booking em inner join event_list el on el.EventId = em.EventId
                                inner join event_type et on el.EventTypeId = et.EventTypeId 
                                where em.User_id = '$userId' AND em.Status= 'Cancelled' order by em.Date desc";
            break;
        ...
        case 5:
            $selectBooking = "SELECT em.*,et.EventType,el.HallNumber FROM
                                event_booking em inner join event_list el on el.EventId = em.EventId
                                inner join event_type et on el.EventTypeId = et.EventTypeId 
                                where em.User_id = '$userId' AND em.Status = 'Rejected' order by em.Date desc";
            break;
        ...
        case 6:
            $selectBooking = "SELECT em.*,et.EventType,el.HallNumber FROM
                                event_booking em inner join event_list el on el.EventId = em.EventId
                                inner join event_type et on el.EventTypeId = et.EventTypeId 
                                where em.User_id = '$userId' AND em.Event_date < CURDATE() order by em.Date desc";
            break;
