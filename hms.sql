...
VALUES
  (
    ...
    'Wedding Hall',
    'wedding.jpg',
    'This hall is a space offered mainly for weddings, birthdays, bridal showers and other personal events. They could be separate or part of a hotel or restaurant.',
    2000,
    'active'
  ),
  (
    ...
    'Meeting Hall',
    'meeting.jpeg',
    'The Killi, Kaveri and Tanjore meeting rooms are the perfect combination of space and ideal ambiance with state of the art amenities and audio visual equipments',
    1200,
    'active'
  ),
  (
    ...
    'Conference Hall',
    'accomadation.jpg',
    'Ten distinct dining destinations featuring Indian & international cuisine along with some of the .....',
    1700,
    'active'
  );
...
VALUES
  (
    ...
    9082931782,
    '',
    'Book Hotel NJ Delight for different purposes. We have various rooms and conference halls for professional meetings.'
  );
...
VALUES
  (
    ...
    'Family Room',
    'away.jpg',
    '32 Inch flat screen TV, Kitchen facilities,Towels,Dining tables',
    1200,
    'active'
  ),
  (
    ...
    'Bachelor Room',
    'F.jpg',
    'Soap & bath amenities,Mini-bar, Telephone',
    1800,
    'active'
  ),
  (
  ...
  (
    ...
    'Club Room ',
    'A.jpg',
    ' Closet with hangers, 24 Hour room service,Computer and Internet access',
    1680,
    'active'
  ),
  (
  ...
  (
    ...
    'Super Deluxe ',
    'club.jpg',
    '32 Inch flat screen TV, HD flat-screen TV,Mini-bar, Telephone',
    3500,
    'active'
  ),
  (
    ...
    'Luxury',
    'super.jpg',
    'Closet with hangers,32 Inch flat screen TV,Mini-bar, Telephone',
    3500,
    'active'
  );
...
ALTER TABLE
  `event_booking`
ADD
  CONSTRAINT `FK_EventBooking` FOREIGN KEY (`EventId`) REFERENCES `event_list` (`EventId`) ON UPDATE CASCADE,
ADD
  CONSTRAINT `FK_UserBooking` FOREIGN KEY (`User_id`) REFERENCES `users_details` (`UserId`) ON UPDATE CASCADE;
...
ALTER TABLE
  `event_list`
ADD
  CONSTRAINT `FK_EventType` FOREIGN KEY (`EventTypeId`) REFERENCES `event_type` (`EventTypeId`) ON UPDATE CASCADE;
...
ALTER TABLE
  `event_payment`
ADD
  CONSTRAINT `FK_EventPayment` FOREIGN KEY (`BookingId`) REFERENCES `event_booking` (`BookingId`) ON UPDATE CASCADE;
...
ALTER TABLE
  `room_booking`
ADD
  CONSTRAINT `FK_RoomBooking` FOREIGN KEY (`RoomId`) REFERENCES `room_list` (`RoomId`) ON UPDATE CASCADE,
ADD
  CONSTRAINT `FK_User` FOREIGN KEY (`User_id`) REFERENCES `users_details` (`UserId`) ON UPDATE CASCADE;
...
ALTER TABLE
  `room_list`
ADD
  CONSTRAINT `FK_RoomType` FOREIGN KEY (`RoomTypeId`) REFERENCES `room_type` (`RoomTypeId`) ON UPDATE CASCADE;
...
ALTER TABLE
  `room_payment`
ADD
  CONSTRAINT `Fk_Booking` FOREIGN KEY (`BookingId`) REFERENCES `room_booking` (`BookingId`) ON UPDATE CASCADE;
